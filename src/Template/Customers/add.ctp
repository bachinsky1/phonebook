...
<div class="customers form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Новый поставщик') ?></legend>
        <?php
            ...
            echo $this->Form->control('emails', ['label'=>'Электронная почта (через запятую)']);
            echo $this->Form->control('categories._ids', ['options' => $categories,'label'=>'Категории']);
        ?>
    </fieldset>
